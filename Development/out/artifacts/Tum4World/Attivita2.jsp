...
<div class="flexbox-container" id="index">
  ...
  <div class="descrizione" id="cura">
    ...
    <p>
      ...
      questo è importante perché ciò che cerchiamo di trasmettere non vale solo per i pappagalli ma per tutta la natura!
  ...
  <div class="descrizione" id="liberazione">
    ...
    <p>
      ...
      <span class="evidenziato">fargli provare in prima persona </span> quanto è bello prendersi cura di questi splendidi animali.
  ...
  <div class="prossimaAttivita">
    ...
    <a href="<%= response.encodeURL("./Attivita3") %>"><img src="assets/images/Attivita1/frecciaDestra.svg" alt="Prossima Attività" id="freccia"></a>
  </div>
