...
@WebServlet(name = "visualizzaAderenti", value = "/visualizzaAderenti")
public class visualizzaAderenti extends HttpServlet {
    Connection conn;
    ...
    public void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException {
        ...
        List<Utente> utenti = utenteDAO.getAllAderenti();

        // Utilizzo il Dao per ottenete la lista degli aderenti
