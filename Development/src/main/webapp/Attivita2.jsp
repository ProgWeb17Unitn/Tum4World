...
<head>
    ...
    <link rel="stylesheet" href="styles/Attivita2.css">
    ...
    <div class="flexbox-container" id="index">
        ...
        <div class="descrizione" id="cura">
            ...
            <p>
                ...
                questo è importante perché ciò che cerchiamo di trasmettere non vale solo per i pappagalli ma per tutta
                la
                natura!
        ...
        <div class="descrizione" id="liberazione">
            ...
            <p>
                Ma il nostro lavoro non si ferma alle parole! Cerchiamo quando possibile di far venire i ragazzi a
                visitare
                il nostro rifugio e di
                <span class="evidenziato">fargli provare in prima persona </span> quanto è bello prendersi cura di
                questi
                splendidi animali.
