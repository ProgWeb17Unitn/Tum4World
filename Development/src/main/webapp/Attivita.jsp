...
<div class="flexbox-container" id="index">
    ...
    <div class="attivita" id="attivita3">
        <div class="Rectangle" id="Rectangle3">
            ...
            <p>Uno dei problemi più imporanti che i pappagalli stanno affrontando in questi anni è la distruzione del
                loro
                habitat naturale. Deforestazione, inquinamento e cambiamenti climatici stanno mettendo a dura prova la
                proliferazione
                della specie, per questo motivo molti dei nostri volontari, aiutati da abitanti ed associazioni amiche
                si impegnano
