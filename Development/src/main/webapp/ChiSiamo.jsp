...
<div class="flexbox-container" id="index">
            ...
            <div class="cartoon" id="cartoonDX1">
                ...
                <div class="Rectangle">
                    <p>La nostra storia prende vita nel
                        ...
                        incantevole
                        ai confini della maestosa Foresta Amazzonica. Il suo amore per la natura e le escursioni l'ha
                        portata ad incontrare
                        John, un maestoso
                        <span class="parole"> Ara Scarlatta </span>
                        ferito ad un'ala. Betty non poteva lasciarlo indietro così decise di portarlo a casa e costruire
                        un
    ...
    <div class="flex-Container-element" id="flex-element2">
        ...
        <div class="elementoSX" id="elementoSX2">
            <div class="cartoon">
                <div class="Rectangle" id="RectangleSX2">
                    <p>
                        Entusiasmanti dalla missione di Betty diverse persone si sono messe in gioco per aiutare questi
                        fantastici animali.
                        Nel
        ...
        <div class="elementoDX" id="colonnaDX2">
            <img src="assets/images/ChiSiamo/imgDX1.jpg" class="images" id="imgDX1">

        </div>
    </div>


    <div class="flex-Container-element" id="flex-element3">

        <div class="elementoSX" id="elementoSX3">
            <img src="assets/images/ChiSiamo/imgSX2.jpg" class="images" id="imgSX2">
        </div>

        <div class="elementoDX" id="colonnaDX3">
            <div class="cartoon" id="cartoonDX3">
                <div class="TriangleSX"></div>
                <div class="Rectangle">
                    <p>Un momento fondamentale per la nostra associazione è stato il
                        ...
                        del loro
                        <span class="parole">ambiente naturale</span>,
    ...
    <div class="flex-Container-element" id="flex-element4">

        <div class="elementoSX" id="elementoSX4">
            <div class="cartoon">
                <div class="Rectangle" id="RectangleSX4">
                    <p>
                        ...
                        <span class="numeri">1000</span>
                        <span class="parole">volontari</span>
                        impegnati nella cura dei nostri pappagalli, nella promozione dela nostra missione,
        ...
        <div class="elementoDX" id="colonnaDX4">
            <img src="assets/images/ChiSiamo/imgDX2.jpg" class="images" id="imgDX2">
