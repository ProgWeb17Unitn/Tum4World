...
<div class="flexbox-container" id="index">
    ...
    <div class="descrizione" id="cura">
        ...
        <p>
            ...
            <span class="evidenziato">deforestazione intensiva</span>. Così come per la lotta all'inquinamento ci uniamo
    ...
    <div class="descrizione" id="liberazione">
        ...
        <p>
            ...
            il quale ci permette di raccogliere dati importanti sulla loro salute, su quella dell'habitat e scoraggia i
            bracconieri.
        </p>
    </div>
