...
<div class="flexbox-container" id="index">
  ...
  <div class="descrizione" id="introduzione">
    ...
    <p>
      Noi volontari siamo numerosi e molto determinati ma non possiamo essere ovunque! È fondamentale riuscire a
  ...
  <div class="descrizione" id="salvataggio">
    ...
    <p>
      Uno dei problemi più importanti per i pappagalli è l'inquinamento dei loro Habitat, molto spesso le foreste
  ...
  <div class="descrizione" id="cura">
    ...
    <p>
      Un altra sfida impegnativa è legata al cambio climatico e la deforestazione. I pappagalli sono poco resistenti ai cambi di temperatura.
      Inoltre in molte zone in cui vivono i governi stanno applicando politiche di
      <span class="evidenziato">deforestazione intensiva</span>. Così come per la lotta all'inquinamento ci uniamo alle associazioni che cercano di tutelare
      ...
      Parchi nazionali e riserve ci permettono di avere il pieno controllo di cosa accade all'interno del loro ambiente e riusciamo ad
  ...
  <div class="descrizione" id="liberazione">
    ...
    <p>
      ...
      il quale ci permette di raccogliere dati importanti sulla loro salute, su quella dell'habitat e scoraggia i bracconieri.
    </p>
  </div>

  <div class="prossimaAttivita">
    <p>Menù Attività</p>
    <a href="<%= response.encodeURL("./Attivita") %>"><img src="assets/images/Attivita1/frecciaDestra.svg" alt="Prossima Attività" id="freccia"></a>
  </div>
